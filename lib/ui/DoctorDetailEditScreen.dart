...
class DoctorDetailWidget extends State<DoctorDetailEditScreen> {
  ...
  void initState() {
    ...
    fNameController.addListener(() {onFNameChanged();});
    lNameController.addListener(() {onLNameChanged();});
    heightController.addListener(() {onHeightChanged();});
    weightController.addListener(() {onWeightChanged();});
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                Align(alignment: Alignment.center,child: CommonUis.getText("", AppColors.black, AppFontSize.size16,weight: AppFontsStyle.BOLD),),
                                Padding(padding: EdgeInsets.only(top: 10,bottom: 15),child: SizedBox(width: 150,height: 30,child: CommonUis.getThemeRaisedButton("UPDATE PROFILE", () {
                      ...
                      child: Container(
                        ...
                        child:ListView(
                          children: [
                            ...
                            SizedBox(height: 10,),
                            getDetailsTiles("FIRST NAME", widget._doctor.first_name,fNameController),
                            getDetailsTiles("LAST NAME", widget._doctor.last_name,lNameController),

                            Padding(padding: EdgeInsets.only(left: 20,bottom: 10),child: CommonUis.getText("GENDER", AppColors.greyTxt, AppFontSize.size14,weight: AppFontsStyle.REGULAR),),
                              ...
                              child: DropdownButton<String>(
                                ...
                                icon: Expanded(
                                  child: Align(
                                    ...
                                    child: Icon(Icons.arrow_drop_down,size: 40,color: AppColors.themeColor,),
                                  ),
                                  flex: 1,
                                ),
                                iconSize: 20,
                                ...
                                items: ["Male","Female"].map<DropdownMenuItem<String>>((String value) {
                                  return DropdownMenuItem<String>(
                                    value: value,
                                    child: CommonUis.getText(value, AppColors.blackTxt, 14.0, ),
                                  );
                                }).toList(),
                              ),
                            ),
                            // getDetailsTiles("GENDER", !AppUtill.isValid(widget._doctor.gender)?"":"${widget._doctor.gender}",genderController),
                            getDetailsTiles("CONTACT NUMBER", "${widget._doctor.primary_contact_no}",null,readOnly: true),
                            Padding(padding: EdgeInsets.only(left: 20,top: 10,bottom: 10),child: CommonUis.getText("DATE OF BIRTH", AppColors.greyTxt, AppFontSize.size14,weight: AppFontsStyle.BOLD),),
                            GestureDetector(
                              onTap: ()
                              {
                                _selectDate();
                            ...
                            Padding(padding: EdgeInsets.only(left: 20,bottom: 10),child: CommonUis.getText("BLOOD GROUP", AppColors.greyTxt, AppFontSize.size14,weight: AppFontsStyle.REGULAR),),
                            ...
                            Container(
                              ...
                              child: DropdownButton<String>(
                                ...
                                items: ["B+","B-","A-","A+","AB+","AB-","O","O-"].map<DropdownMenuItem<String>>((String value) {
                                  return DropdownMenuItem<String>(
                                    value: value,
                                    child: CommonUis.getText(value, AppColors.blackTxt, 14.0, ),
                                  );
                            ...
                            getDetailsTiles("HEIGHT", widget._doctor.height,heightController,textInputType: TextInputType.number,maxLength: 3),
                            getDetailsTiles("WEIGHT", widget._doctor.weight,weightController,textInputType: TextInputType.number,maxLength: 4),
  ...
  Container getDetailsTiles(String title,String content,TextEditingController controller,{bool readOnly=false,TextInputType textInputType=TextInputType.text,int maxLength=50})
  {
    if(controller!=null)
      {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 8,),
          CommonUis.getCommonTextField(hint: title,controller: controller,readOnly: readOnly,textInputType: textInputType,maxLength: maxLength),
        ],
      ),
    );
  }
        ...
        children: [
          Row(
            ...
            children: [
              ...
              CommonUis.getText("${title}", AppColors.greyTxt, AppFontSize.size14,weight: AppFontsStyle.REGULAR),
              SizedBox(width: 5,),
              Icon(Icons.arrow_drop_down_circle_outlined,size: 15,color: AppColors.themeColor,),
  ...
  _selectDate() async {
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    CupertinoButton(
                      child: Text('Done'),
                      onPressed: () {
                        AppUtill.printAppLog("pickedDate::::${DateTimeConverter.convert(tempPickedDate.toString(),outputFormat: "yyyy-MM-dd")} / ${tempPickedDate.toString()}");
    ...
    if (pickedDate != null) {
      String d=DateTimeConverter.convert(pickedDate.toString(),outputFormat: "yyyy-MM-dd");
